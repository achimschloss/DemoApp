...
class ServiceViewModel: NSObject, ObservableObject {
    ...
    func initializeNetIdService() {
        ...
        let permissionLayerConfig = PermissionLayerConfig(
                headlineText: "Privatsphäre-Einstellungen CustomText",
                //legalText: "Indem Sie Ihre Einwilligung erteilen, geben Sie [Formulierung Partnername] die Erlaubnis, Sie bei der Nutzung unserer Angebote, insbesondere dieser App, als netID Nutzer:in zu identifizieren und Ihren netID Identifier für [Formulierung Verwendung/Zwecke] zu verwenden. Durch Nutzung von netID können Ihnen Einwilligungsdialoge bei der Nutzung unserer Angebote, insbesondere dieser App, dann seltener angezeigt werden. \n\n",
                legalText: "Bereits vorhandene Einwilligungen hinterlegen wir in ihrem netID Privacy Center, inbesonders auch eine solche bzgl. Ihrer Identifizierung als netID Nutzer:in. Durch Nutzung von netID können Ihnen Einwilligungsdialoge bei der Nutzung unserer Angebote, insbesondere dieser App, dann seltener angezeigt werden.\n\n",
                continueText: "Zustimmen CustomText")
